 ...
 */
public interface CancellableCompletionService<U extends CancellableTask.CancellationReason> {
    /**
     ...
     * @throws NullPointerException       if the {@code task}
     */
    <V, C extends Callable<V> & CancellableTask<U>>
    CancellableFuture<V, U> submit(C task);
    ...
    CancellableFuture<V, U> submit(R task, V result);
}
